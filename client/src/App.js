...
class App extends Component {
    ...
    render() {
        ...
        return (
            ...
            <Tabs styles={{minWidth : 1200}} onChange={this.handleChange}>
            <Tab label="PLANET" value="planet">
            {this.state.tab_index === "planet" ? <PlanetPage/> : ''}
            </Tab>
            <Tab label="MATERIAL" value="material">
            {this.state.tab_index === "material" ? <MaterialPage/> : ''}
            </Tab>
            <Tab label="GEOMETRY" value="geometry">
            {this.state.tab_index === "geometry" ? <GeometryPage/> : ''}
            </Tab>
            <Tab label="INFO" value="info">
            {this.state.tab_index === "info" ? <InfoPage /> : ''}
            </Tab>
            <Tab label="ABOUT">
            <div>
            <DevelopPage/>
            ...
            <IconButton  tooltip="Roweax's Github" style={{
                ...
                height: '64px',
                width: '64px'
            }} href="https://github.com/Roweax" tooltipPosition="top-center">
